...
class MComingCell: UITableViewCell {
    //MARK: -properties
    ...
    var source: [Any] = [] {
        didSet {
            if source.count != 0 {
                comingCollectionView.reloadData()
            }
        }
    }
    ...
    override func awakeFromNib() {
        ...
        comingCollectionView.register(UINib(nibName: MComingItemCell.cellId, bundle: nil), forCellWithReuseIdentifier: MComingItemCell.cellId)
...
extension MComingCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
