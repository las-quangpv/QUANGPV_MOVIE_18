...
class MByGenreVM: BaseViewModel {
    private (set) var headerData : [Movie] = [] // get 3 items first
    ...
    func loadData() {
        ...
        (self.apiService as! MovieAPI).fetchDiscoverByGenre(genreId: self.id, page: self.page) { result in
            switch result {
