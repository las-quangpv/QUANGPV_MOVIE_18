...
public struct HTMLCharacterReferences {
    ...
    public static func standard() -> HTMLCharacterReferences {
        return HTMLCharacterReferences(
            named: ReferenceNamed.file("named"),
            substitute: ReferenceSubstitute.file("sti")
        )
    }
...
public protocol Codepoints: Decodable {
...
public extension CustomScanner {
