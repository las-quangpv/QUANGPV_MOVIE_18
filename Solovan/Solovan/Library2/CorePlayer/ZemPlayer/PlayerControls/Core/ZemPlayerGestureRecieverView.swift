...
open class ZemPlayerGestureRecieverView: UIView {
    
    /// ZemPlayerGestureRecieverViewDelegate instance
    public weak var delegate: ZemPlayerGestureRecieverViewDelegate? = nil
