...
class VideoTrimmerThumb: UIView {
	...
	var leadingChevronImageView = UIImageView(image: UIImage(named: "ic_left_cutter"))
	var trailingChevronView = UIImageView(image: UIImage(named: "ic_right_cutter"))
	...
	private func updateColor() {
		let color = UIColor(hex: 0x57BEEE)
